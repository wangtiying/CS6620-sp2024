        ...
        <div>
            ...
            <ul className="list-group">
                <li className="list-group-item">
                    <button className="btn btn-primary w-50 float-end" onClick={() => dispatch(addCourse({ title: courseTitle }))}>
                        Add Courses
                    </button>
                    <input className="form=control w-50" value={courseTitle} onChange={(e) => setCourseTitle(e.target.value)} />
                </li>
